...
_RAW_TOOL_CATALOG = [
    ...
    {"label": "⚡ Swing Trading (Estrategias)", "bloque": "📈 Mercado y Timing", "input_mode": "standalone", "descripcion": "Escáner de setups a días/semanas al alza y a la baja, con régimen de mercado, plan de riesgo y validación histórica.", "strategic_group": "market"},
    ...
    {"label": "📐 Mi Cartera vs Índice", "bloque": "💼 Cartera y Decisión", "input_mode": "standalone", "descripcion": "Rendimiento real de tu cartera frente a haber invertido el mismo dinero, en los mismos momentos, en uno o varios índices.", "strategic_group": "portfolio"},
    {"label": "🚪 Decisión de Venta", "bloque": "💼 Cartera y Decisión", "input_mode": "standalone", "descripcion": "Para una posición ya abierta: mantener, reducir o vender, combinando valoración, deterioro del negocio y técnica.", "strategic_group": "portfolio"},
    {"label": "📓 Diario de Decisiones", "bloque": "💼 Cartera y Decisión", "input_mode": "standalone", "descripcion": "Registro de operaciones tomadas y descartadas, con análisis de qué setups y qué salidas te funcionan.", "strategic_group": "portfolio"},
